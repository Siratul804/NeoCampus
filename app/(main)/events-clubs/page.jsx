...
import CreateEventModal from "@/components/events-clubs/CreateEventModal";
...
export default function UniversityPortal() {
  ...
  const categories = [
    "all",
    ...new Set(clubsData.map((club) => club.category)),
  ];
    ...
    <div className="container mx-auto p-4 space-y-6">
      <div className="flex flex-col space-y-2">
        <h1 className="text-3xl font-bold tracking-tight">
          University Events & Clubs
        </h1>
        <p className="text-muted-foreground">
          Discover events, join clubs, and stay connected with campus activities
        </p>
      </div>
                  ...
                  {selectedDateEvents.length > 0 ? (
                    ...
                    <div className="flex flex-col items-center justify-center h-full py-8">
                      ...
                      <p className="text-muted-foreground text-center mt-2">
                        There are no events scheduled for this date. Try
